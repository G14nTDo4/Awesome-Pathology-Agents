...
* [PathFLIP: Fine-grained Language-Image Pretraining for Versatile Computational Pathology](https://arxiv.org/pdf/2512.17621), AAAI 2026, [![Star](https://img.shields.io/github/stars/cyclexfy/PathFLIP.svg?style=social&label=Star)](https://github.com/cyclexfy/PathFLIP).
...
* [BEACON: Beyond Relevance–Bayesian Evidence Acquisition for Agentic Whole-Slide Image Reasoning](https://arxiv.org/pdf/2608.05757), arxiv 2026, [![Star](https://img.shields.io/github/stars/bryanwong17/BEACON.svg?style=social&label=Star)](https://github.com/bryanwong17/BEACON).
...
* [DeepSpot: Leveraging Spatial Context for Enhanced Spatial Transcriptomics Prediction from H&E Images](https://www.medrxiv.org/content/10.1101/2025.02.09.25321567v3), medRxiv 2025, [![Star](https://img.shields.io/github/stars/ratschlab/DeepSpot.svg?style=social&label=Star)](https://github.com/ratschlab/DeepSpot).
* [DeepSpot2Cell: Predicting Virtual Single-Cell Spatial Transcriptomics from H&E images using Spot-Level Supervision](https://openreview.net/forum?id=ofCkwXQKaz), NeurIPS 2025 Imageomics, [![Star](https://img.shields.io/github/stars/ratschlab/DeepSpot2Cell.svg?style=social&label=Star)](https://github.com/ratschlab/DeepSpot2Cell).
* [DeepSpot-M: a multimodal foundation model for transcriptome-wide virtual spatial transcriptomics from histology](https://www.medrxiv.org/content/10.64898/2026.06.19.26356060v1), medRxiv 2026, [![Star](https://img.shields.io/github/stars/ratschlab/DeepSpotM.svg?style=social&label=Star)](https://github.com/ratschlab/DeepSpotM).
...
* [PathNavigate: A Training-Free Pathology Agent with Surprise-Guided Scan and Shared Slide Memory for Whole-Slide Image VQA](https://arxiv.org/abs/2605.23559), arxiv 2026, [![Star](https://img.shields.io/github/stars/cs-w0r1d/qcagent.svg?style=social&label=Star)](https://github.com/cs-w0r1d/qcagent)
* [QCAgent: An agentic framework for quality-controllable pathology report generation from whole slide image](https://arxiv.org/abs/2603.01647), arXiv 2026, [![Star](https://img.shields.io/github/stars/Pureeeee/PathNavigate_.svg?style=social&label=Star)](https://github.com/Pureeeee/PathNavigate_)
...
* [PathFound: An Agentic Multimodal Model Activating Evidence-seeking Pathological Diagnosis](https://arxiv.org/abs/2512.23545), MedIA 2026.
* [Adaptive Diagnostic Reasoning Framework for Pathology with Multimodal Large Language Models](https://www.nature.com/articles/s43856-026-01491-z), Communications Medicine 2026.
...
* [PathView-Bench: Can Multimodal Large Language Models Achieve Fine-grained Multiscale Understanding of Pathology Images?](https://arxiv.org/abs/2607.28318), arxiv 2026.
...
* [TCGA virtual spatial transcriptomics atlas](https://www.medrxiv.org/content/10.64898/2026.06.19.26356060v1), medRxiv 2026, [Data](https://huggingface.co/datasets/ratschlab/TCGA_virtual_spatial_transcriptomics_atlas), [![Star](https://img.shields.io/github/stars/ratschlab/DeepSpotM.svg?style=social&label=Star)](https://github.com/ratschlab/DeepSpotM).
* [HEST Xenium virtual spatial transcriptomics](https://www.medrxiv.org/content/10.64898/2026.06.19.26356060v1), medRxiv 2026, [Data](https://huggingface.co/datasets/ratschlab/HEST_Xenium_virtual_spatial_transcriptomics), [![Star](https://img.shields.io/github/stars/ratschlab/DeepSpotM.svg?style=social&label=Star)](https://github.com/ratschlab/DeepSpotM).
